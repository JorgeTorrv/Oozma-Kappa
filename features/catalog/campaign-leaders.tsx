  ...
  return (
    <div className="space-y-5">
      <div className="flex justify-end">
        <DialogButton
          label="Crear líder nuevo"
          title="Crear un líder nuevo para esta campaña"
          width="lg"
        >
          <CampaignLeaderCreateForm campaignId={campaignId} />
        </DialogButton>
      </div>
...
function CampaignLeaderCreateForm({ campaignId }: { campaignId: string }) {
